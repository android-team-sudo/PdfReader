package team.pdfreader.fragment;
...
import team.pdfreader.activity.FavouritesActivity;
import team.pdfreader.activity.MainActivity;
import team.pdfreader.customviews.MyCardView;
import team.pdfreader.fragment.texttopdf.TextToPdfFragment;
import team.pdfreader.model.HomePageItem;
import team.pdfreader.util.CommonCodeUtils;

import static team.pdfreader.util.Constants.ADD_IMAGES;
import static team.pdfreader.util.Constants.ADD_IMAGES_KEY;
import static team.pdfreader.util.Constants.ADD_PASSWORD_KEY;
import static team.pdfreader.util.Constants.ADD_PWD;
import static team.pdfreader.util.Constants.ADD_TEXT_KEY;
import static team.pdfreader.util.Constants.ADD_WATERMARK;
import static team.pdfreader.util.Constants.ADD_WATERMARK_KEY;
import static team.pdfreader.util.Constants.BUNDLE_DATA;
import static team.pdfreader.util.Constants.COMPRESS_PDF;
import static team.pdfreader.util.Constants.COMPRESS_PDF_KEY;
import static team.pdfreader.util.Constants.EXCEL_TO_PDF_KEY;
import static team.pdfreader.util.Constants.EXTRACT_IMAGES;
import static team.pdfreader.util.Constants.EXTRACT_IMAGES_KEY;
import static team.pdfreader.util.Constants.EXTRACT_TEXT_KEY;
import static team.pdfreader.util.Constants.HISTORY_KEY;
import static team.pdfreader.util.Constants.IMAGE_TO_PDF_KEY;
import static team.pdfreader.util.Constants.INVERT_PDF_KEY;
import static team.pdfreader.util.Constants.MERGE_PDF_KEY;
import static team.pdfreader.util.Constants.PDF_TO_IMAGES;
import static team.pdfreader.util.Constants.PDF_TO_IMAGES_KEY;
import static team.pdfreader.util.Constants.QR_BARCODE_KEY;
import static team.pdfreader.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static team.pdfreader.util.Constants.REMOVE_PAGES;
import static team.pdfreader.util.Constants.REMOVE_PAGES_KEY;
import static team.pdfreader.util.Constants.REMOVE_PASSWORD_KEY;
import static team.pdfreader.util.Constants.REMOVE_PWd;
import static team.pdfreader.util.Constants.REORDER_PAGES;
import static team.pdfreader.util.Constants.REORDER_PAGES_KEY;
import static team.pdfreader.util.Constants.ROTATE_PAGES;
import static team.pdfreader.util.Constants.ROTATE_PAGES_KEY;
import static team.pdfreader.util.Constants.SPLIT_PDF_KEY;
import static team.pdfreader.util.Constants.TEXT_TO_PDF_KEY;
import static team.pdfreader.util.Constants.VIEW_FILES_KEY;
import static team.pdfreader.util.Constants.ZIP_TO_PDF_KEY;

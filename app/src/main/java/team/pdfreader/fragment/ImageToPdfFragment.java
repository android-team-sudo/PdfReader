...
import team.pdfreader.activity.CropImageActivity;
import team.pdfreader.activity.ImageEditor;
import team.pdfreader.activity.PreviewActivity;
import team.pdfreader.activity.RearrangeImages;
import team.pdfreader.adapter.EnhancementOptionsAdapter;
import team.pdfreader.database.DatabaseHelper;
import team.pdfreader.interfaces.OnItemClickListener;
import team.pdfreader.interfaces.OnPDFCreatedInterface;
import team.pdfreader.model.EnhancementOptionsEntity;
import team.pdfreader.model.ImageToPDFOptions;
import team.pdfreader.model.Watermark;
import team.pdfreader.util.Constants;
import team.pdfreader.util.CreatePdf;
import team.pdfreader.util.DialogUtils;
import team.pdfreader.util.FileUtils;
import team.pdfreader.util.ImageEnhancementOptionsUtils;
import team.pdfreader.util.ImageUtils;
import team.pdfreader.util.MorphButtonUtility;
import team.pdfreader.util.PageSizeUtils;
import team.pdfreader.util.PermissionsUtils;
import team.pdfreader.util.StringUtils;

import static team.pdfreader.util.Constants.AUTHORITY_APP;
import static team.pdfreader.util.Constants.DEFAULT_BORDER_WIDTH;
import static team.pdfreader.util.Constants.DEFAULT_COMPRESSION;
import static team.pdfreader.util.Constants.DEFAULT_IMAGE_BORDER_TEXT;
import static team.pdfreader.util.Constants.DEFAULT_IMAGE_SCALE_TYPE_TEXT;
import static team.pdfreader.util.Constants.DEFAULT_PAGE_COLOR;
import static team.pdfreader.util.Constants.DEFAULT_PAGE_SIZE;
import static team.pdfreader.util.Constants.DEFAULT_PAGE_SIZE_TEXT;
import static team.pdfreader.util.Constants.DEFAULT_QUALITY_VALUE;
import static team.pdfreader.util.Constants.IMAGE_SCALE_TYPE_ASPECT_RATIO;
import static team.pdfreader.util.Constants.MASTER_PWD_STRING;
import static team.pdfreader.util.Constants.OPEN_SELECT_IMAGES;
import static team.pdfreader.util.Constants.READ_WRITE_CAMERA_PERMISSIONS;
import static team.pdfreader.util.Constants.RESULT;
import static team.pdfreader.util.Constants.STORAGE_LOCATION;
import static team.pdfreader.util.Constants.appName;
import static team.pdfreader.util.WatermarkUtils.getStyleNameFromFont;
import static team.pdfreader.util.WatermarkUtils.getStyleValueFromName;

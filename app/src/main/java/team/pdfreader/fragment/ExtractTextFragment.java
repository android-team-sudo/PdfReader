...
import static team.pdfreader.util.Constants.textExtension;
...
public class ExtractTextFragment extends Fragment implements MergeFilesAdapter.OnClickListener,
    ...
    public void selectPdfFile() {
        if (!mButtonClicked) {
            ...
            try {
                startActivityForResult(Intent.createChooser(intent, String.valueOf(R.string.select_file)), mFileSelectCode);
                mButtonClicked = true;

...
import team.pdfreader.preferences.TextToPdfPreferences;
...
public class FontFamilyEnhancer implements Enhancer {
    ...
    FontFamilyEnhancer(@NonNull final Activity activity,
        ...
        mBuilder = builder;
        mEnhancementOptionsEntity = new EnhancementOptionsEntity(mActivity, R.drawable.ic_font_family, String.format(mActivity.getString(R.string.default_font_family_text), mBuilder.getFontFamily().name()));
        mView = view;
    }
    /**
